...
const Homepage = () => {
  return (
    <div>
      ...
      <div className='container-fluid top'>
        <div className="row">
          <div className='col-8 top-head'>
            ...
            <p>Welcome to MLRIT Engineering College Bus Service! Ensuring safe, reliable, and convenient transportation for our students and staff. Explore our services and find out how we make your daily commute easier. College Chariot is a platform that provides bus pass services to students</p>
      ...
      <Element name="popular-routes" className="element">
        <PopularRoutes />
      </Element>
          ...
          {/* <div 
          style={{
            background: "rgb(38,32,143)",
  background: "linear-gradient(90deg, rgba(38,32,143,1) 0%, rgba(0,212,255,1) 51%, rgba(9,9,121,1) 95%)",
          }}>
          <PopularRoutes/>
        </div> */}
